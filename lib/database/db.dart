...
class DBHelper {
  ...
  static const TABLE_STUDENT = 'student';
  static const TABLE_ATTENDANCE = 'attendance';
  static const TABLE_GROUP = 'student_group';
  ...
  Future<List<Map<String, dynamic>>> getStudentAttendence(
    ...
    print(date);
    var db = await getDB();
    List<Map<String, dynamic>> studentAttendance = await db
        .rawQuery("SELECT s.roll_no, name, surname, status AS attending_status "
